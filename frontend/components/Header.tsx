        ...
        >
          ...
          {totalItems > 0 && (
            <motion.span
              ...
              className="absolute -top-1.5 -right-1.5 bg-brand text-white text-[10px] font-extrabold min-w-[20px] h-5 px-1 rounded-full flex items-center justify-center shadow-sm"
            >
