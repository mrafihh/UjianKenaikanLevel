...
[![PDFKit](https://img.shields.io/badge/PDFKit-Receipt-FF1744?style=for-the-badge&logo=adobe&logoColor=white)](http://pdfkit.org/)
...
| **Payment**  | Xendit QRIS                                        |
| **Receipt/Billing** | PDFKit 0.18+ untuk generate struk PDF        |
...
- ✅ **Receipt/Struk PDF** — Generate & download struk pesanan dalam format PDF (A6 thermal receipt size)
...
<details open>
<summary><strong>📄 Receipt & Billing</strong></summary>

| Method | Endpoint              | Akses   | Deskripsi                                   |
| ------ | --------------------- | ------- | ------------------------------------------- |
| GET    | `/orders/:id/receipt` | Publik  | Download struk PDF pesanan (A6 thermal)     |
...
### Download Receipt/Struk PDF

```bash
# Download struk untuk order #42
GET /orders/42/receipt
Content-Type: application/json

# Response: File PDF dengan nama: struk-restoku-42.pdf
# Ukuran kertas: A6 (thermal receipt 80mm x 297mm)
# Format include:
#   - Header: RESTOKU APP
#   - No. Nota, Tanggal, Customer, Meja, Metode Pembayaran
#   - List item menu dengan Qty dan Total harga
...
├────────────────────────────────┤
│ No. Nota  : #ORD-42            │
│ Tanggal   : 3/6/2026 11:00     │
│ Customer  : Budi               │
│ Meja      : 5                  │
│ Metode    : ONLINE             │
├────────────────────────────────┤
│ Item              Qty    Total  │
│ Nasi Goreng Spesial  2x  Rp50K  │
│ Es Teh Manis         1x  Rp 5K  │
├────────────────────────────────┤
│ Subtotal       :  Rp 55.000    │
│ Pajak          :  Rp  5.500    │
│ TOTAL          :  Rp 60.500    │
...
- [ ] Enhance receipt dengan QR code pembayaran
- [x] ~~Basic CRUD menu & order~~
- [x] ~~JWT authentication~~
- [x] ~~Xendit QRIS integration~~
- [x] ~~Cloudinary image upload~~
- [x] ~~Swagger documentation~~
- [x] ~~Generate struk pesanan dalam format PDF (PDFKit)~~
